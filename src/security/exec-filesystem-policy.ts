...
import type { SandboxToolPolicy, SandboxWorkspaceAccess } from "../agents/sandbox/types.js";
...
function isExecFilesystemConstrained(params: {
  ...
  return params.sandboxWorkspaceAccess !== "rw" && params.sandboxWorkspaceAccess !== "persist";
}
